...
The above result was obtained in a classic Windows console, showing that Kickstart input deals correctly with non-English characters in this environment, which is helpful because as of early 2021 [current implementations of the C++ standard library fail to input non-ASCII characters](detail_-_input_of_international_text_in_Windows.md) as UTF-8.
