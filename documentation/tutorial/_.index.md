...
Beginners that don't use the Kickstart library, or some other library like Kickstart, typically insert a “stop here” statement at the end of the program. It can be a portable input statement, or it can be e.g. a Windows-specific `system("pause")`. Anyway that’s problematic in several ways:
