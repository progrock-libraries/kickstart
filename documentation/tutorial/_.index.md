...
**`Array_span_`** is a basic array span class template. Kickstart’s `Array_span_` corresponds to a pared down C++20 [`std::span`](https://en.cppreference.com/w/cpp/container/span) with dynamic extent.
