...
The following code expands on the usage example the cxxopts site by displaying the parse results, and replaces use of standard library i/o and `main` arguments, with Kickstart i/o and singleton `process::the_commandline()`:
